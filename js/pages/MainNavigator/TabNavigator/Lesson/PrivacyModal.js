      ...
      <View style={styles.position}>
        <View style={styles.container}>
          <View style={styles.card}>
            <Text style={styles.title}>ROSEN用户协议及隐私政策</Text>
            <View style={{ flex: 1 }}>
              <ScrollView style={{ flex: 1 }}>
                <View style={styles.contentView}>
                  <Text style={styles.content}>
                    感谢您下载并使用ROSEN小学阅读馆应用程序，我们非常重视您的个人信息和隐私保护。在您使用ROSEN小学阅读馆和产品和服务前，<Text
                    ...
                    <Text style={styles.content2}>
                      如果您是未满18周岁的未成年人，请通知您的监护人共同阅读以上协议并特别关注未成年人信息保护部分，并在使用我们的产品、服务或提交个人信息之前，寻求他们的同意和指导。{
                        '\n'
                      }如您使用ROSEN小学阅读馆的产品和服务，请您点击同意后使用。
...
const styles = StyleSheet.create({
  ...
  card: {
    width: UI.size.deviceWidth - UI.scaleSize(40) * 2,
    height: UI.scaleSize(450),
